...
// GnatenkoPavel.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGnatenkoPavelApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CGnatenkoPavelApp::OnAppAbout)
...
// Создание CGnatenkoPavelApp

CGnatenkoPavelApp::CGnatenkoPavelApp() noexcept
{
	...
	SetAppID(_T("GnatenkoPavel.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CGnatenkoPavelApp

CGnatenkoPavelApp theApp;


// Инициализация CGnatenkoPavelApp

BOOL CGnatenkoPavelApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CGnatenkoPavelDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CGnatenkoPavelView));
	if (!pDocTemplate)
		return FALSE;
...
int CGnatenkoPavelApp::ExitInstance()
{
...
// Обработчики сообщений CGnatenkoPavelApp
...
void CGnatenkoPavelApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
