...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CGnatenkoPavelView), CSize(200, 450), pContext);
	m_wndSplitter.CreateView(1, 0, RUNTIME_CLASS(MyView), CSize(0, 0), pContext);
